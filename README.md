...
**Twitter** is an android app that allows a user to view their Twitter timeline. The app utilizes the [Twitter REST API](https://dev.twitter.com/rest/public).
...
### Notes
I did not encounter any challenges while building this part of the app.
